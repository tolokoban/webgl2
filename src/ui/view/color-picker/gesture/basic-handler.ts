...
class BasicHandler {
    public deviceHandlers: IDeviceHandlers = {}
    public readonly element: HTMLElement
    public fingers: Finger = new Finger()
    public mouseType = ""
    public mouseTypeTime = 0
     ...
     */
    public checkMouseType(mouseType: string): boolean {
        const now = Date.now()
...
export default (element: HTMLElement,
                ...
                handleUp: TBasicHandler,
                handleMove: TBasicHandler) =>
    new BasicHandler(element, handleDown, handleUp, handleMove)
